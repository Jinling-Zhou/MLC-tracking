...
% This version did not take into consideration the time that takes MLC to
% its control locations. However, could add the 50ms to the latency result to
% roughly estimate the real latency.
