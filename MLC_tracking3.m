...
% Just started to test different parameters. Decided to draft a batch processing version instead.
...
[correlation, lag] = xcorr(Tumor_trace(:,moveaxis), control_trace(:,moveaxis));
